            ...
            <div >
                <div className=" py-10 !bg-black !text-white">
                    <div className="max-w-lg mx-auto md:max-w-none md:grid md:grid-cols-2 md:gap-8">
                        <div>
                            <h2 className="text-xl font-medium sm:text-3xl">Sales Support</h2>
                            <div className="mt-3">
                                <p className=" text-stone-400">Nullam risus blandit ac aliquam justo ipsum. Quam mauris volutpat massa dictumst amet. Sapien tortor lacus arcu.</p>
                            </div>
                            <div className="mt-9">
                                <div className="flex">
                                    ...
                                    <div className="ml-3 text-base text-stone-400">
                                        <p>+1 (555) 123 4567</p>
                        ...
                        <div className="mt-12 sm:mt-16 md:mt-0">
                            <h2 className="text-xl font-medium sm:text-3xl">Technical Support</h2>
                            <div className="mt-3">
                                <p className=" text-stone-400">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Magni, repellat error corporis doloribus similique, voluptatibus numquam quam, quae officiis facilis.</p>
                            </div>
                            <div className="mt-9">
                                <div className="flex">
                                    <div className="flex-shrink-0">

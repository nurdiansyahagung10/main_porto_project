    ...
    return (
        ...
        <div className="w-full mt-20 mb-10 flex justify-center">
          ...
          <div className="w-full flex flex-col mb-10 items-center text-center">
            ...
            <p className="text-stone-600 pe-22 md:w-[50%]">Lets sneak a peek at the project where Ive transformed it into a new solution with my design approach.</p>
          </div>
              ...
              <div className="mt-7 flex items-center justify-between">
                ...
                <button className="py-1.5 items-center flex gap-1 bg-white  border   font-medium rounded-xl px-4 " >
                  <div className="flex gap-2 items-center">
                    ...
                    <span><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2.5" stroke="currentColor" className="size-4">

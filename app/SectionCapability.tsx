        ...
        <>
            ...
            <div >
                ...
                <div className="w-full flex flex-col  items-center text-center">
                    ...
                    <p className="text-stone-600 pe-22 md:w-[50%]">Discover our capabilities. The full list.</p>
                </div>
            </div>
            <div className="pt-10">
                <Swiper
            ...
            <div className="mt-10">
                <Swiper
                    ...
                    className="mySwiper pointer-events-none"
                >
                    <SwiperSlide className="p-2 px-3 !w-[auto] bg-black rounded-xl text-white flex  justify-center">
                        <div className="items-center flex justify-content gap-2">
                            <div className="p-1 rounded-lg border border-stone-600 bg-stone-800">
